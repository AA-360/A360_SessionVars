...
public final class GetTextVariableCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(GetTextVariableCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    GetTextVariable command = new GetTextVariable();
