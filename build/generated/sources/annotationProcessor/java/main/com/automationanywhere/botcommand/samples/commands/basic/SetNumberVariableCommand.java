...
public final class SetNumberVariableCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(SetNumberVariableCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    SetNumberVariable command = new SetNumberVariable();
    ...
    if(parameters.containsKey("value") && parameters.get("value") != null && parameters.get("value").get() != null) {
      ...
      if(convertedParameters.get("value") !=null && !(convertedParameters.get("value") instanceof Double)) {
        throw new BotCommandException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","value", "Double", parameters.get("value").get().getClass().getSimpleName()));
      }
    }
    ...
    try {
      command.action((String)convertedParameters.get("varName"),(Double)convertedParameters.get("value"),(String)convertedParameters.get("type"),(Boolean)convertedParameters.get("isConstant"));Optional<Value> result = Optional.empty();
