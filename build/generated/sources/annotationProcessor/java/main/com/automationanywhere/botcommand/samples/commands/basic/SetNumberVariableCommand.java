...
public final class SetNumberVariableCommand implements BotCommand {
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    try {
      command.action((String)convertedParameters.get("varName"),(Double)convertedParameters.get("value"),(Boolean)convertedParameters.get("isConstant"));Optional<Value> result = Optional.empty();
