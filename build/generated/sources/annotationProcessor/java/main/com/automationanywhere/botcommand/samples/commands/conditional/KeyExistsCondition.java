...
public final class KeyExistsCondition implements Condition {
  private static final Logger logger = LogManager.getLogger(KeyExistsCondition.class);
  ...
  public boolean test(GlobalSessionContext globalSessionContext, Map<String, Value> parameters,
    ...
    KeyExists command = new KeyExists();
