...
public final class BooleanKeyCondition implements Condition {
  private static final Logger logger = LogManager.getLogger(BooleanKeyCondition.class);
  ...
  public boolean test(GlobalSessionContext globalSessionContext, Map<String, Value> parameters,
    ...
    BooleanKey command = new BooleanKey();
    ...
    try {
      boolean result = command.validate((String)convertedParameters.get("varName"),(Boolean)convertedParameters.get("value"),(String)convertedParameters.get("type"));
