...
public final class SetTextVariableCommand implements BotCommand {
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    try {
      command.action((String)convertedParameters.get("varName"),(String)convertedParameters.get("value"),(Boolean)convertedParameters.get("isConstant"));Optional<Value> result = Optional.empty();
