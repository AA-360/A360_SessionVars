...
public final class SetTextVariableCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(SetTextVariableCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    SetTextVariable command = new SetTextVariable();
    ...
    try {
      command.action((String)convertedParameters.get("varName"),(String)convertedParameters.get("value"),(String)convertedParameters.get("type"),(Boolean)convertedParameters.get("isConstant"));Optional<Value> result = Optional.empty();
