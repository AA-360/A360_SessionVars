...
public final class AddToListVariableCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(AddToListVariableCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    AddToListVariable command = new AddToListVariable();
