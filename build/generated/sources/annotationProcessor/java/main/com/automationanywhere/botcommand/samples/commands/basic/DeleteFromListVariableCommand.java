...
public final class DeleteFromListVariableCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(DeleteFromListVariableCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    DeleteFromListVariable command = new DeleteFromListVariable();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("varName"),(String)convertedParameters.get("value"),(String)convertedParameters.get("type")));
